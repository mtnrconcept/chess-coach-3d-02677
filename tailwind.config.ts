  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "board-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--board-highlight) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--board-highlight) / 0.6)" },
        },
        "fade-in-up": {
          "0%": {
            opacity: "0",
      ...
      animation: {
        ...
        "piece-slide": "piece-slide 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",
